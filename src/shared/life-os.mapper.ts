...
export function toShoppingItemValues(item: ShoppingItem): typeof shoppingItems.$inferInsert {
  return {
    ...
    warrantyDocuments: item.warrantyDocuments ?? [],
...
export function shoppingItemFromRow(item: typeof shoppingItems.$inferSelect): ShoppingItem {
  return {
    ...
    receiptDocuments: (item.receiptDocuments as ShoppingItem["receiptDocuments"]) ?? [],
    warrantyStatus: item.warrantyStatus as ShoppingItem["warrantyStatus"],
    warrantyExpiresAt: item.warrantyExpiresAt ?? undefined,
    warrantyNote: item.warrantyNote ?? undefined,
    warrantyDocuments: (item.warrantyDocuments as ShoppingItem["warrantyDocuments"]) ?? [],
